...
class RAGEvaluator:
    ...
    def score_faithfulness(self, answer: str, context: str) -> float:
        ...
        bigram_score = (
            _jaccard_similarity(answer_bigrams, context_bigrams) if answer_bigrams else 0.0
        )
        ...
        sentence_score = sum(sentence_scores) / len(sentence_scores) if sentence_scores else 0.0
